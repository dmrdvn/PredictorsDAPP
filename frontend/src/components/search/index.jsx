...
export default function Search() {
    return (
        <div className="min-h-[30px] mt-3 h-[50px] flex items-center p-3">
            <label className="h-[43px] rounded-full bg-[#0f172a] w-full group border border-transparent focus-within:bg-[#eef3f41a] focus-within:bg-[#eef3f41a] flex justify-between">
